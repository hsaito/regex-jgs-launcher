...
- **0.2.12**:
	- Security: Added npm override to force Lodash 4.17.23+ to mitigate prototype pollution vulnerability (CVE-2020-8203) in transitive dependencies
...
- **0.2.9**:
	...
	- Updated release automation to publish VSIX on tagged builds
...
- **0.2.6** (withdrawn / replaced by 0.2.7):
	- Documentation & metadata alignment (no functional changes vs 0.2.5)
	- Ensured semantic version compliance after removing doc-only 0.2.5.1 bump
